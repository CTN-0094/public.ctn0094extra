...
#'    subjects were randomised to Phase I of their respective studies (the
...
#'    weekly visit. Defaults to 0. Under this default behaviour with weekly
